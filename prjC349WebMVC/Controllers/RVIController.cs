...
namespace prjC349WebMVC.Controllers
{
    ...
    public class RVIController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create(remote_visua_inspection remote_visua_inspection)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.Add(new MySqlParameter("@updateTime", MySqlDbType.Date)).Value = DateTime.Now;
        ...
        [HttpPost]
        public ActionResult Edit(remote_visua_inspection remote_visua_inspection)
        {
            if (ModelState.IsValid)
            {
                MySqlCommand cmd = new MySqlCommand();
        ...
        // GET: Home
        private List<remote_visua_inspection> GetAllRecrods(string queryMonth)
        {
            ...
            List<remote_visua_inspection> employees = new List<remote_visua_inspection>();
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                employees.Add(new remote_visua_inspection
                {
        ...
        private remote_visua_inspection GetRecrod(string id)
        {
            MySqlConnection conn = new MySqlConnection(connStr);
            conn.ConnectionString = connStr;
            ...
            adp.Fill(ds);
            DataTable dt = ds.Tables[0];
            remote_visua_inspection emp = new remote_visua_inspection
            {
        ...
        {
            List<remote_visua_inspection> remote_Visua_Inspections = GetAllRecrods("");
